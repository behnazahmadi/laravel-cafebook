(function($){
    ...
    /* Start "راه حل های دیجیتال", "ارز دیجیتال", "بازاریابی رسانه اجتماعی" و "امنیت سایبری" "Demo JS" */
...
try {
	...
	function setTheme(themeName) {
		localStorage.setItem('turacos_rtl_theme', themeName);
		document.documentElement.className = themeName;
	}
	// function to toggle between light and dark theme
	function toggleTheme() {
		if (localStorage.getItem('turacos_rtl_theme') === 'theme-dark') {
