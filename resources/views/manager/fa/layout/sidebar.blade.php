    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu">
            <ul class="list">
                <li>
                    <div class="sidebar-profile clearfix">
                        <div class="profile-img">
                            <img src="{{asset("default-profile.png")}}" alt="profile">
                        </div>
                ...
                <li class="active">
                    <a href="{{route("manager.home")}}" onClick="return false;" class="menu-toggle">
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{route("manager.category.index")}}">لیست دسته بندی ها</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="{{route("manager.blogs.index")}}">لیست بلاگ ها</a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        <li>
                            <a href="pages/ui/alerts.html">لیست کاربران</a>
                        </li>
