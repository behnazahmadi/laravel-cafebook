                                ...
                                <div class="row clearfix">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="name" class="form-control" value="{{$category->categoryName}}" placeholder="نام دسته بندی">
                                            </div>
                                            <br>
                                            @if($errors->has("name"))
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="slug" class="form-control" value="{{$category->slug}}" placeholder="اسلاگ">
                                            </div>
                                            <br>
                                            @if($errors->has("slug"))
